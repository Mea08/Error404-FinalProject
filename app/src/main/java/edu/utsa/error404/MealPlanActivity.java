    ...
    private void setupButtons(){
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(workoutCount(wText.getText().toString(), Integer.parseInt(tText.getText().toString()))) {
                    Intent intent = new Intent(edu.utsa.error404.MealPlanActivity.this, MainActivity.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(edu.utsa.error404.MealPlanActivity.this, MainActivity.class); //FIX ME
        ...
        customButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(edu.utsa.error404.MealPlanActivity.this, "Clicked Add", Toast.LENGTH_SHORT).show();
        ...
        customButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(edu.utsa.error404.MealPlanActivity.this, "Clicked Subtract", Toast.LENGTH_SHORT).show();
                veggies = veggieCalPerAmount; meat = meatCalPerAmount; fruit = fruitCalPerAmount; oil = oilCalPerAmount;
                carbs = carbsCalPerAmount; dairy = dairyCalPerAmount; sweets = sweetsCalPerAmount;
                currentVal = sumTotal;
                n3 = (EditText) findViewById(R.id.editTextNumber3);
